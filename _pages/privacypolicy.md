...
If you enable Apple Health integration, Pump can share your workouts with Apple Health based on the permissions you grant. Pump can only read workouts that it has written to Apple Health and cannot read workouts written by any other app. This is done solely to keep them in sync when you edit or delete them within Pump.

Pump may also ask permission to read your heart rate and energy data. This allows Apple Health to record readings from any connected sensors, such as headphones or a heart rate monitor, while a workout is in progress and include them in that workout. Your current heart rate is shown in Pump and on your Lock Screen as you train. Pump only reads this data during a workout, it is read on your device alone, and it is never sent to us or to any third party.
